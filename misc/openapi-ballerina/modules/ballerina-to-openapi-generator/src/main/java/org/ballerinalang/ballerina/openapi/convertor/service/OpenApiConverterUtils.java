...
public class OpenApiConverterUtils {
     ...
     * @param genType         Generation type used to detect whether invoked using the cli tool
     ...
     */
    public static String generateOAS3Definitions(String ballerinaSource, String serviceName, String genType)
        ...
        try {
            ...
            if (annoIterator.hasNext() && isServiceAnnotationAvailable != null
                    && !"openapi-gen-contract".equals(genType)) {
     ...
     * @see #generateOAS3Definitions(String, String, String)
     */
    public static void generateOAS3Definitions(Path servicePath, Path outPath, String serviceName, String genType)
        ...
        String openApiSource = generateOAS3Definitions(balSource, serviceName, genType);
