 ...
 */
/* eslint-disable */
class OasAddResponse extends React.Component {
    ...
    render() {
        return (
            <Form size='mini' className='add-operation'>
                <Form.Field>
                    <Form.Field control={Select} label='Response Status' placeholder='200 - OK' onChange={(e, data) =>{
...
OasAddResponse.prototypes = {
    onAddOperation: propTypes.func,
    path: propTypes.string,
}

export default OasAddResponse;
